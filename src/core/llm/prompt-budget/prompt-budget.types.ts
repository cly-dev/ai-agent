...
export type PromptBudgetCallKind =
  | 'decision'
  | 'summarize'
  | 'plan'
  | 'routing'
...
export type PromptBlockPayload =
  ...
  | { type: 'observations'; observations: ObservationPayload[]; preamble?: string }
  | { type: 'tool_schema'; json: string }
  | { type: 'session_goa'; section: SessionGoaSection; text: string };
