...
// @ts-nocheck 
/*
 * This file exports the `RoleTool` model and its related types.
 *
...
export type RoleToolAggregateArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
   * Filter which RoleTool to aggregate.
   */
  where?: Prisma.RoleToolWhereInput
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/sorting Sorting Docs}
   * 
   * Determine the order of RoleTools to fetch.
   */
   ...
   * 
   * Take `±n` RoleTools from the position of the cursor.
   */
  take?: number
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
   * 
   * Skip the first `n` RoleTools.
   */
  skip?: number
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
   * 
   * Count returned RoleTools
  **/
...
export type GetRoleToolAggregateType<T extends RoleToolAggregateArgs> = {
      [P in keyof T & keyof AggregateRoleTool]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateRoleTool[P]>
    : Prisma.GetScalarType<T[P], AggregateRoleTool[P]>
}
...
export type GetRoleToolGroupByPayload<T extends RoleToolGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<RoleToolGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof RoleToolGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], RoleToolGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], RoleToolGroupByOutputType[P]>
      }
    >
  >
...
export type RoleToolCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<RoleToolFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface RoleToolDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['RoleTool'], meta: { name: 'RoleTool' } }
  /**
   * Find zero or one RoleTool that matches the filter.
   * @param {RoleToolFindUniqueArgs} args - Arguments to find a RoleTool
   * @example
   * // Get one RoleTool
   * const roleTool = await prisma.roleTool.findUnique({
   *   where: {
   *     // ... provide filter here
   *   }
   * })
  ...
  /**
   * Find one RoleTool that matches the filter or throw an error with `error.code='P2025'`
   * if no matches were found.
   * @param {RoleToolFindUniqueOrThrowArgs} args - Arguments to find a RoleTool
   * @example
   * // Get one RoleTool
   * const roleTool = await prisma.roleTool.findUniqueOrThrow({
   *   where: {
   *     // ... provide filter here
   *   }
   * })
  ...
  /**
   * Find the first RoleTool that matches the filter.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {RoleToolFindFirstArgs} args - Arguments to find a RoleTool
   * @example
   * // Get one RoleTool
   * const roleTool = await prisma.roleTool.findFirst({
   *   where: {
   *     // ... provide filter here
   *   }
   * })
  ...
  /**
   * Find the first RoleTool that matches the filter or
   * throw `PrismaKnownClientError` with `P2025` code if no matches were found.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {RoleToolFindFirstOrThrowArgs} args - Arguments to find a RoleTool
   * @example
   * // Get one RoleTool
   * const roleTool = await prisma.roleTool.findFirstOrThrow({
   *   where: {
   *     // ... provide filter here
   *   }
   * })
  ...
  /**
   * Find zero or more RoleTools that matches the filter.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {RoleToolFindManyArgs} args - Arguments to filter and select certain fields only.
   * @example
   * // Get all RoleTools
   * const roleTools = await prisma.roleTool.findMany()
   * 
   * // Get first 10 RoleTools
   * const roleTools = await prisma.roleTool.findMany({ take: 10 })
   * 
   * // Only select the `id`
   * const roleToolWithIdOnly = await prisma.roleTool.findMany({ select: { id: true } })
   * 
   */
  ...
  /**
   * Create a RoleTool.
   * @param {RoleToolCreateArgs} args - Arguments to create a RoleTool.
   * @example
   * // Create one RoleTool
   * const RoleTool = await prisma.roleTool.create({
   *   data: {
   *     // ... data to create a RoleTool
   *   }
   * })
   * 
   */
  ...
  /**
   * Create many RoleTools.
   * @param {RoleToolCreateManyArgs} args - Arguments to create many RoleTools.
   * @example
   * // Create many RoleTools
   * const roleTool = await prisma.roleTool.createMany({
   *   data: [
   *     // ... provide data here
   *   ]
   * })
  ...
  /**
   * Create many RoleTools and returns the data saved in the database.
   * @param {RoleToolCreateManyAndReturnArgs} args - Arguments to create many RoleTools.
   * @example
   * // Create many RoleTools
   * const roleTool = await prisma.roleTool.createManyAndReturn({
   *   data: [
   *     // ... provide data here
   *   ]
   * })
   * 
   * // Create many RoleTools and only return the `id`
   * const roleToolWithIdOnly = await prisma.roleTool.createManyAndReturn({
   *   select: { id: true },
   *   data: [
   *     // ... provide data here
   *   ]
  ...
  /**
   * Delete a RoleTool.
   * @param {RoleToolDeleteArgs} args - Arguments to delete one RoleTool.
   * @example
   * // Delete one RoleTool
   * const RoleTool = await prisma.roleTool.delete({
   *   where: {
   *     // ... filter to delete one RoleTool
   *   }
   * })
   * 
   */
  ...
  /**
   * Update one RoleTool.
   * @param {RoleToolUpdateArgs} args - Arguments to update one RoleTool.
   * @example
   * // Update one RoleTool
   * const roleTool = await prisma.roleTool.update({
   *   where: {
   *     // ... provide filter here
   *   },
   *   data: {
  ...
  /**
   * Delete zero or more RoleTools.
   * @param {RoleToolDeleteManyArgs} args - Arguments to filter RoleTools to delete.
   * @example
   * // Delete a few RoleTools
   * const { count } = await prisma.roleTool.deleteMany({
   *   where: {
   *     // ... provide filter here
   *   }
   * })
  ...
  /**
   * Update zero or more RoleTools.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {RoleToolUpdateManyArgs} args - Arguments to update one or more rows.
   * @example
   * // Update many RoleTools
   * const roleTool = await prisma.roleTool.updateMany({
   *   where: {
   *     // ... provide filter here
   *   },
   *   data: {
  ...
  /**
   * Update zero or more RoleTools and returns the data updated in the database.
   * @param {RoleToolUpdateManyAndReturnArgs} args - Arguments to update many RoleTools.
   * @example
   * // Update many RoleTools
   * const roleTool = await prisma.roleTool.updateManyAndReturn({
   *   where: {
   *     // ... provide filter here
   *   },
   *   data: [
   ...
   * })
   * 
   * // Update zero or more RoleTools and only return the `id`
   * const roleToolWithIdOnly = await prisma.roleTool.updateManyAndReturn({
   *   select: { id: true },
   *   where: {
   *     // ... provide filter here
   *   },
  ...
  /**
   * Create or update one RoleTool.
   * @param {RoleToolUpsertArgs} args - Arguments to update or create a RoleTool.
   * @example
   * // Update or create a RoleTool
   * const roleTool = await prisma.roleTool.upsert({
   *   create: {
   *     // ... data to create a RoleTool
   *   },
   *   update: {
   ...
   *   },
   *   where: {
   *     // ... the filter for the RoleTool we want to update
   *   }
   * })
   */
  ...
  /**
   * Count the number of RoleTools.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {RoleToolCountArgs} args - Arguments to filter RoleTools to count.
   * @example
   * // Count the number of RoleTools
   * const count = await prisma.roleTool.count({
   *   where: {
   *     // ... the filter for the RoleTools we want to count
   *   }
   * })
  **/
  count<T extends RoleToolCountArgs>(
    args?: Prisma.Subset<T, RoleToolCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], RoleToolCountAggregateOutputType>
      : number
  >

  /**
   * Allows you to perform aggregations operations on a RoleTool.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {RoleToolAggregateArgs} args - Select which aggregations you would like to apply and on what fields.
   * @example
  ...
  **/
   ...
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {RoleToolGroupByArgs} args - Group by arguments.
   * @example
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, RoleToolGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetRoleToolGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
 * Fields of the RoleTool model
 */
readonly fields: RoleToolFieldRefs;
}

/**
 * The delegate class that acts as a "Promise-like" for RoleTool.
...
export type RoleToolFindUniqueArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  /**
   * Filter, which RoleTool to fetch.
   */
  where: Prisma.RoleToolWhereUniqueInput
}

/**
 * RoleTool findUniqueOrThrow
 */
...
export type RoleToolFindFirstArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
   ...
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
   * 
   * Sets the position for searching for RoleTools.
   */
  cursor?: Prisma.RoleToolWhereUniqueInput
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
...
export type RoleToolFindManyArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  include?: Prisma.RoleToolInclude<ExtArgs> | null
  /**
   * Filter, which RoleTools to fetch.
   */
  where?: Prisma.RoleToolWhereInput
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/sorting Sorting Docs}
   ...
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
   * 
   * Sets the position for listing RoleTools.
   */
  cursor?: Prisma.RoleToolWhereUniqueInput
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
...
export type RoleToolCreateArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  include?: Prisma.RoleToolInclude<ExtArgs> | null
  /**
   * The data needed to create a RoleTool.
   */
...
export type RoleToolCreateManyArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
   * The data used to create many RoleTools.
   */
...
export type RoleToolUpdateManyArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
   * The data used to update RoleTools.
   */
  data: Prisma.XOR<Prisma.RoleToolUpdateManyMutationInput, Prisma.RoleToolUncheckedUpdateManyInput>
  /**
   * Filter which RoleTools to update
   */
  where?: Prisma.RoleToolWhereInput
  /**
   * Limit how many RoleTools to update.
   */
  limit?: number
}

/**
 * RoleTool updateManyAndReturn
 */
...
export type RoleToolUpsertArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  include?: Prisma.RoleToolInclude<ExtArgs> | null
  /**
   * The filter to search for the RoleTool to update in case it exists.
   */
  where: Prisma.RoleToolWhereUniqueInput
  /**
   * In case the RoleTool found by the `where` argument doesn't exist, create a new RoleTool with this data.
   */
  create: Prisma.XOR<Prisma.RoleToolCreateInput, Prisma.RoleToolUncheckedCreateInput>
  /**
   * In case the RoleTool was found with the provided `where` argument, update it with this data.
   */
...
export type RoleToolDeleteArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  include?: Prisma.RoleToolInclude<ExtArgs> | null
  /**
   * Filter which RoleTool to delete.
   */
  where: Prisma.RoleToolWhereUniqueInput
}
...
export type RoleToolDeleteManyArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
   * Filter which RoleTools to delete
   */
  where?: Prisma.RoleToolWhereInput
  /**
   * Limit how many RoleTools to delete.
   */
  limit?: number
}

/**
 * RoleTool without action
 */
