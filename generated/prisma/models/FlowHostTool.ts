...
// @ts-nocheck 
/*
 * This file exports the `FlowHostTool` model and its related types.
 *
...
export type FlowHostToolAggregateArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
   * Filter which FlowHostTool to aggregate.
   */
  where?: Prisma.FlowHostToolWhereInput
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/sorting Sorting Docs}
   * 
   * Determine the order of FlowHostTools to fetch.
   */
   ...
   * 
   * Take `±n` FlowHostTools from the position of the cursor.
   */
  take?: number
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
   * 
   * Skip the first `n` FlowHostTools.
   */
  skip?: number
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
   * 
   * Count returned FlowHostTools
  **/
...
export type GetFlowHostToolAggregateType<T extends FlowHostToolAggregateArgs> = {
      [P in keyof T & keyof AggregateFlowHostTool]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateFlowHostTool[P]>
    : Prisma.GetScalarType<T[P], AggregateFlowHostTool[P]>
}
...
export type GetFlowHostToolGroupByPayload<T extends FlowHostToolGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<FlowHostToolGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof FlowHostToolGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], FlowHostToolGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], FlowHostToolGroupByOutputType[P]>
      }
    >
  >
...
export type FlowHostToolCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<FlowHostToolFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface FlowHostToolDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['FlowHostTool'], meta: { name: 'FlowHostTool' } }
  /**
   * Find zero or one FlowHostTool that matches the filter.
   * @param {FlowHostToolFindUniqueArgs} args - Arguments to find a FlowHostTool
   * @example
   * // Get one FlowHostTool
   * const flowHostTool = await prisma.flowHostTool.findUnique({
   *   where: {
   *     // ... provide filter here
   *   }
   * })
  ...
  /**
   * Find one FlowHostTool that matches the filter or throw an error with `error.code='P2025'`
   * if no matches were found.
   * @param {FlowHostToolFindUniqueOrThrowArgs} args - Arguments to find a FlowHostTool
   * @example
   * // Get one FlowHostTool
   * const flowHostTool = await prisma.flowHostTool.findUniqueOrThrow({
   *   where: {
   *     // ... provide filter here
   *   }
   * })
  ...
  /**
   * Find the first FlowHostTool that matches the filter.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {FlowHostToolFindFirstArgs} args - Arguments to find a FlowHostTool
   * @example
   * // Get one FlowHostTool
   * const flowHostTool = await prisma.flowHostTool.findFirst({
   *   where: {
   *     // ... provide filter here
   *   }
   * })
  ...
  /**
   * Find the first FlowHostTool that matches the filter or
   * throw `PrismaKnownClientError` with `P2025` code if no matches were found.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {FlowHostToolFindFirstOrThrowArgs} args - Arguments to find a FlowHostTool
   * @example
   * // Get one FlowHostTool
   * const flowHostTool = await prisma.flowHostTool.findFirstOrThrow({
   *   where: {
   *     // ... provide filter here
   *   }
   * })
  ...
  /**
   * Find zero or more FlowHostTools that matches the filter.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {FlowHostToolFindManyArgs} args - Arguments to filter and select certain fields only.
   * @example
   * // Get all FlowHostTools
   * const flowHostTools = await prisma.flowHostTool.findMany()
   * 
   * // Get first 10 FlowHostTools
   * const flowHostTools = await prisma.flowHostTool.findMany({ take: 10 })
   * 
   * // Only select the `id`
   * const flowHostToolWithIdOnly = await prisma.flowHostTool.findMany({ select: { id: true } })
   * 
   */
  ...
  /**
   * Create a FlowHostTool.
   * @param {FlowHostToolCreateArgs} args - Arguments to create a FlowHostTool.
   * @example
   * // Create one FlowHostTool
   * const FlowHostTool = await prisma.flowHostTool.create({
   *   data: {
   *     // ... data to create a FlowHostTool
   *   }
   * })
   * 
   */
  ...
  /**
   * Create many FlowHostTools.
   * @param {FlowHostToolCreateManyArgs} args - Arguments to create many FlowHostTools.
   * @example
   * // Create many FlowHostTools
   * const flowHostTool = await prisma.flowHostTool.createMany({
   *   data: [
   *     // ... provide data here
   *   ]
   * })
  ...
  /**
   * Create many FlowHostTools and returns the data saved in the database.
   * @param {FlowHostToolCreateManyAndReturnArgs} args - Arguments to create many FlowHostTools.
   * @example
   * // Create many FlowHostTools
   * const flowHostTool = await prisma.flowHostTool.createManyAndReturn({
   *   data: [
   *     // ... provide data here
   *   ]
   * })
   * 
   * // Create many FlowHostTools and only return the `id`
   * const flowHostToolWithIdOnly = await prisma.flowHostTool.createManyAndReturn({
   *   select: { id: true },
   *   data: [
   *     // ... provide data here
   *   ]
  ...
  /**
   * Delete a FlowHostTool.
   * @param {FlowHostToolDeleteArgs} args - Arguments to delete one FlowHostTool.
   * @example
   * // Delete one FlowHostTool
   * const FlowHostTool = await prisma.flowHostTool.delete({
   *   where: {
   *     // ... filter to delete one FlowHostTool
   *   }
   * })
   * 
   */
  ...
  /**
   * Update one FlowHostTool.
   * @param {FlowHostToolUpdateArgs} args - Arguments to update one FlowHostTool.
   * @example
   * // Update one FlowHostTool
   * const flowHostTool = await prisma.flowHostTool.update({
   *   where: {
   *     // ... provide filter here
   *   },
   *   data: {
  ...
  /**
   * Delete zero or more FlowHostTools.
   * @param {FlowHostToolDeleteManyArgs} args - Arguments to filter FlowHostTools to delete.
   * @example
   * // Delete a few FlowHostTools
   * const { count } = await prisma.flowHostTool.deleteMany({
   *   where: {
   *     // ... provide filter here
   *   }
   * })
  ...
  /**
   * Update zero or more FlowHostTools.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {FlowHostToolUpdateManyArgs} args - Arguments to update one or more rows.
   * @example
   * // Update many FlowHostTools
   * const flowHostTool = await prisma.flowHostTool.updateMany({
   *   where: {
   *     // ... provide filter here
   *   },
   *   data: {
  ...
  /**
   * Update zero or more FlowHostTools and returns the data updated in the database.
   * @param {FlowHostToolUpdateManyAndReturnArgs} args - Arguments to update many FlowHostTools.
   * @example
   * // Update many FlowHostTools
   * const flowHostTool = await prisma.flowHostTool.updateManyAndReturn({
   *   where: {
   *     // ... provide filter here
   *   },
   *   data: [
   ...
   * })
   * 
   * // Update zero or more FlowHostTools and only return the `id`
   * const flowHostToolWithIdOnly = await prisma.flowHostTool.updateManyAndReturn({
   *   select: { id: true },
   *   where: {
   *     // ... provide filter here
   *   },
  ...
  /**
   * Create or update one FlowHostTool.
   * @param {FlowHostToolUpsertArgs} args - Arguments to update or create a FlowHostTool.
   * @example
   * // Update or create a FlowHostTool
   * const flowHostTool = await prisma.flowHostTool.upsert({
   *   create: {
   *     // ... data to create a FlowHostTool
   *   },
   *   update: {
   ...
   *   },
   *   where: {
   *     // ... the filter for the FlowHostTool we want to update
   *   }
   * })
   */
  ...
  /**
   * Count the number of FlowHostTools.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {FlowHostToolCountArgs} args - Arguments to filter FlowHostTools to count.
   * @example
   * // Count the number of FlowHostTools
   * const count = await prisma.flowHostTool.count({
   *   where: {
   *     // ... the filter for the FlowHostTools we want to count
   *   }
   * })
  **/
  count<T extends FlowHostToolCountArgs>(
    args?: Prisma.Subset<T, FlowHostToolCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], FlowHostToolCountAggregateOutputType>
      : number
  >

  /**
   * Allows you to perform aggregations operations on a FlowHostTool.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {FlowHostToolAggregateArgs} args - Select which aggregations you would like to apply and on what fields.
   * @example
  ...
  **/
  ...
  /**
   * Group by FlowHostTool.
   * Note, that providing `undefined` is treated as the value not being there.
   * Read more here: https://pris.ly/d/null-undefined
   * @param {FlowHostToolGroupByArgs} args - Group by arguments.
   * @example
  ...
  **/
  groupBy<
    T extends FlowHostToolGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, FlowHostToolGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetFlowHostToolGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
 * Fields of the FlowHostTool model
 */
readonly fields: FlowHostToolFieldRefs;
}

/**
 * The delegate class that acts as a "Promise-like" for FlowHostTool.
...
export type FlowHostToolFindUniqueArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  /**
   * Filter, which FlowHostTool to fetch.
   */
  where: Prisma.FlowHostToolWhereUniqueInput
}

/**
 * FlowHostTool findUniqueOrThrow
 */
...
export type FlowHostToolFindFirstArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
   ...
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
   * 
   * Sets the position for searching for FlowHostTools.
   */
  cursor?: Prisma.FlowHostToolWhereUniqueInput
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
...
export type FlowHostToolFindManyArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  include?: Prisma.FlowHostToolInclude<ExtArgs> | null
  /**
   * Filter, which FlowHostTools to fetch.
   */
  where?: Prisma.FlowHostToolWhereInput
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/sorting Sorting Docs}
   ...
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
   * 
   * Sets the position for listing FlowHostTools.
   */
  cursor?: Prisma.FlowHostToolWhereUniqueInput
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination Pagination Docs}
...
export type FlowHostToolCreateManyArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
   * The data used to create many FlowHostTools.
   */
...
/**
 * FlowHostTool createManyAndReturn
 */
...
export type FlowHostToolUpdateArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  include?: Prisma.FlowHostToolInclude<ExtArgs> | null
  /**
   * The data needed to update a FlowHostTool.
   */
  data: Prisma.XOR<Prisma.FlowHostToolUpdateInput, Prisma.FlowHostToolUncheckedUpdateInput>
  /**
   * Choose, which FlowHostTool to update.
   */
  where: Prisma.FlowHostToolWhereUniqueInput
}

/**
 * FlowHostTool updateMany
 */
export type FlowHostToolUpdateManyArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
   * The data used to update FlowHostTools.
   */
  data: Prisma.XOR<Prisma.FlowHostToolUpdateManyMutationInput, Prisma.FlowHostToolUncheckedUpdateManyInput>
  /**
   * Filter which FlowHostTools to update
   */
  where?: Prisma.FlowHostToolWhereInput
  /**
   * Limit how many FlowHostTools to update.
   */
  limit?: number
}

/**
 * FlowHostTool updateManyAndReturn
 */
...
export type FlowHostToolUpsertArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  include?: Prisma.FlowHostToolInclude<ExtArgs> | null
  /**
   * The filter to search for the FlowHostTool to update in case it exists.
   */
  where: Prisma.FlowHostToolWhereUniqueInput
  /**
   * In case the FlowHostTool found by the `where` argument doesn't exist, create a new FlowHostTool with this data.
   */
  create: Prisma.XOR<Prisma.FlowHostToolCreateInput, Prisma.FlowHostToolUncheckedCreateInput>
  /**
   * In case the FlowHostTool was found with the provided `where` argument, update it with this data.
   */
...
export type FlowHostToolDeleteArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  include?: Prisma.FlowHostToolInclude<ExtArgs> | null
  /**
   * Filter which FlowHostTool to delete.
   */
  where: Prisma.FlowHostToolWhereUniqueInput
}

/**
 * FlowHostTool deleteMany
 */
export type FlowHostToolDeleteManyArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
   * Filter which FlowHostTools to delete
   */
  where?: Prisma.FlowHostToolWhereInput
  /**
   * Limit how many FlowHostTools to delete.
   */
  limit?: number
}

/**
 * FlowHostTool without action
 */
