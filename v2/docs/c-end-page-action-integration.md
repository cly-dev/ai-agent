...
> **相关文档**：[c-end-auto-agent-integration.md](./c-end-auto-agent-integration.md)（Chat）、[outbound-network-guide.md](./outbound-network-guide.md)（断连/失败提示）、[frontend-workflow-config-guide.md §8](./frontend-workflow-config-guide.md#8-c-端-pageaction-invoke)（Workflow 执行行为）。
