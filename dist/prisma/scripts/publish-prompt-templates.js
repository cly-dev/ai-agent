...
const redis_client_options_util_1 = require("../../src/core/memory/redis/redis-client-options.util");
...
async function syncPublishedRowsToRedis(templateIds) {
    ...
    const password = ((_b = process.env.REDIS_PASSWORD) === null || _b === void 0 ? void 0 : _b.trim()) || undefined;
    const redis = new ioredis_1.default(redisUrl, (0, redis_client_options_util_1.buildIoRedisClientOptions)({ password }));
    try {
        await redis.connect();
