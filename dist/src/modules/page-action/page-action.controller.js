...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'hostToolId 始终可选。分析类可不绑；填入类绑 HostTool；绑 Workflow 时 push 节点优先用 nodes[].input.hostToolId。',
    }),
...
__decorate([
    (0, common_1.Delete)('page-action/:id'),
    ...
    __metadata("design:returntype", void 0)
], PageActionController.prototype, "remove", null);
__decorate([
