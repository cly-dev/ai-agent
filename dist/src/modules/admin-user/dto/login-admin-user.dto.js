...
__decorate([
    (0, swagger_1.ApiProperty)({ description: '管理员登录邮箱', example: 'admin@example.com' }),
    (0, class_validator_1.IsEmail)(),
    __metadata("design:type", String)
], LoginAdminUserDto.prototype, "email", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: '管理员登录密码', example: 'strong-pass-123' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.MinLength)(5),
    __metadata("design:type", String)
], LoginAdminUserDto.prototype, "password", void 0);
exports.LoginAdminUserDto = LoginAdminUserDto;
//# sourceMappingURL=login-admin-user.dto.js.map