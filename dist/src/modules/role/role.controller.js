...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: '分页查询角色列表' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: '按 ID 查询角色' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: '查询成功' }),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, swagger_1.ApiParam)({ name: 'id', type: Number }),
    (0, swagger_1.ApiOperation)({ summary: '按 ID 更新角色' }),
...
__decorate([
    ...
    (0, swagger_1.ApiParam)({ name: 'id', type: Number }),
    (0, swagger_1.ApiOperation)({ summary: '按 ID 删除角色' }),
