...
export declare function mapHttpProfileResponse(payload: unknown, mapping: AppClientProfileFieldMapping, responseRoot?: string): ExternalAccountProfile;
...
export declare function fetchHttpProfileAccount(http: AppClientHttpAuthConfig, accountToken: string): Promise<ExternalAccountProfile>;
