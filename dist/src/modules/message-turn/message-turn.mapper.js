...
exports.toMessageTurnResponseList = exports.toMessageTurnResponse = void 0;
...
function toMessageTurnResponse(row) {
...
exports.toMessageTurnResponse = toMessageTurnResponse;
function toMessageTurnResponseList(rows) {
    return rows.map(toMessageTurnResponse);
}
exports.toMessageTurnResponseList = toMessageTurnResponseList;
//# sourceMappingURL=message-turn.mapper.js.map