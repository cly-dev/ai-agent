...
export declare class LlmService implements OnApplicationBootstrap {
    ...
    private static readonly DEFAULT_SUMMARIZE_OUTPUT_TOKEN_RESERVE;
    ...
    resolveInvocationMaxTokens(messages: LlmChatMessage[], hints?: PromptBudgetHints): Promise<number>;
    getMessageTokenBudget(hints?: PromptBudgetHints): Promise<number>;
    ...
    private readSummarizeOutputTokenReserve;
    private resolveOutputTokenReserve;
