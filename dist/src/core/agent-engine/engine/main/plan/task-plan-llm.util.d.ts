...
import type { BuildTaskPlanInput, ResolveOuterPlanInput, ResolveTaskPlanInput, ResolveTaskPlanResult, TaskPlanStep } from './task-plan.types';
...
export declare function normalizeOuterLlmPlanSteps(raw: z.infer<typeof llmOuterPlanSchema>, scopedToolSummaries: ResolveOuterPlanInput['scopedToolSummaries'], availableSkillIds: Set<number>, scopedHostToolNames: Set<string>): NormalizePlanStepsResult;
export declare function normalizeLlmPlanSteps(raw: LlmTaskPlanOutput, scopedToolSummaries: BuildTaskPlanInput['scopedToolSummaries'], scopedHostToolNames: Set<string>): NormalizePlanStepsResult;
