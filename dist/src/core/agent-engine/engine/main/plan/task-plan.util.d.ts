...
export declare function buildOrchestratedTemplatePlanResult(input: {
    userMessage: string;
    scopedToolSummaries: BuildTaskPlanInput['scopedToolSummaries'];
    deliverable: TaskDeliverable;
...
export declare function planGatherRequiresFullFetch(step: TaskPlanStep | null | undefined): boolean;
