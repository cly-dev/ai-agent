...
exports.resolveInitialPlanRunContext = exports.planRunContextFromState = exports.planObservationBucketsFromState = exports.selectObservationsForPagedGatherResume = exports.selectObservationsForPlanToolSatisfaction = exports.allowsWorkingMemoryForPlanAnswer = exports.planRunContextFromResumeDecision = void 0;
...
function planRunContextFromResumeDecision(decision) {
...
exports.planRunContextFromResumeDecision = planRunContextFromResumeDecision;
function allowsWorkingMemoryForPlanAnswer(planRunContext) {
    return planRunContext === 'resume';
}
exports.allowsWorkingMemoryForPlanAnswer = allowsWorkingMemoryForPlanAnswer;
