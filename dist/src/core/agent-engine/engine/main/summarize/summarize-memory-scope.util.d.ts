...
export type SummarizeMemoryScopeReason = 'current_run_gather_complete' | 'follow_up_working_memory' | 'fresh_topic_current_run_only' | 'working_memory_only' | 'current_run_only' | 'both_buckets' | 'filter_miss' | 'empty';
