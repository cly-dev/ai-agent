    ...
    async streamSummarizeProseOnly(messages, sessionId, runId, ruleBlocks, fallbackPlainText, publishMode) {
        ...
        if (rawSource && (0, message_blocks_util_1.looksLikeBlocksJsonOutput)(rawSource)) {
            ...
            if (disobeyed === null || disobeyed === void 0 ? void 0 : disobeyed.length) {
                ...
                this.logger.warn(`summarize prose_stream: unparseable blocks JSON runId=${runId}`);
                const recovered = (0, message_blocks_util_1.extractProseFromSummarizeLlmRaw)(rawSource);
                if (recovered) {
                    llmBlocksForStorage = (0, message_blocks_util_1.filterLlmBlocksAvoidDuplicatingRule)(ruleBlocks, [
                        (0, message_blocks_util_1.textBlock)(recovered, 'markdown'),
                    ]);
                }
                else {
            ...
            const proseForStorage = (0, summarize_prose_stream_util_1.resolveSummarizeLlmProseForStorage)({
                proseSession,
                rawSource,
                userMarkdown,
                routedMessage,
        ...
        const recoveredProse = (0, message_blocks_util_1.extractProseFromSummarizeLlmRaw)(rawSource);
        if (recoveredProse) {
            const currentText = (_c = (_b = llmBlocksForStorage.find((block) => block.type === 'text')) === null || _b === void 0 ? void 0 : _b.content.trim()) !== null && _c !== void 0 ? _c : '';
            if (recoveredProse.length > currentText.length) {
                llmBlocksForStorage = (0, message_blocks_util_1.filterLlmBlocksAvoidDuplicatingRule)(ruleBlocks, [
                    (0, message_blocks_util_1.textBlock)(recoveredProse, 'markdown'),
                ]);
            }
        }
