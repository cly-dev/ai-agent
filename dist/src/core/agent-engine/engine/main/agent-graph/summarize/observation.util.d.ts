...
export declare function buildSummarizeObservationFromState(state: Pick<AgentGraphState, 'preloadedToolObservations' | 'toolObservations' | 'workflowRun'>, planContext?: {
