...
function createToolsNode(bundle) {
    ...
    return async (state) => {
        ...
        const gatherLlm = {
            ...
            currentObjective: (_d = (_b = (0, plan_paged_gather_util_1.resolvePagedGatherSummarizeObjective)(state.taskPlan)) !== null && _b !== void 0 ? _b : (_c = state.taskPlan) === null || _c === void 0 ? void 0 : _c.currentObjective) !== null && _d !== void 0 ? _d : undefined,
