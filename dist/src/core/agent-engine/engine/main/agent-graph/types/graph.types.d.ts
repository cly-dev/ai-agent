...
import type { AgentGraphState, AgentLangGraphRunInput, ToolObservation } from '../../types/agent-engine.types';
...
export type AgentGraphNodeFn = (state: AgentGraphState) => Promise<AgentGraphState>;
