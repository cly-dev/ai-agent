...
export declare function createAgentGraphStateAnnotation(): import("@langchain/langgraph/dist/graph/annotation").AnnotationRoot<{
    ...
    materializedEntities: import("@langchain/langgraph/dist/channels/base").BaseChannel<MaterializedEntity[], MaterializedEntity[] | import("@langchain/langgraph/dist/constants").OverwriteValue<MaterializedEntity[]>, unknown>;
    ...
    workflowIr: import("@langchain/langgraph/dist/channels/base").BaseChannel<WorkflowIrDocument, WorkflowIrDocument | import("@langchain/langgraph/dist/constants").OverwriteValue<WorkflowIrDocument>, unknown>;
    workflowExecutionMode: import("@langchain/langgraph/dist/channels/base").BaseChannel<WorkflowExecutionMode, WorkflowExecutionMode | import("@langchain/langgraph/dist/constants").OverwriteValue<WorkflowExecutionMode>, unknown>;
