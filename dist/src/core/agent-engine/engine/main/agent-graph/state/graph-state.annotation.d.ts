...
export declare function createAgentGraphStateAnnotation(): import("@langchain/langgraph/dist/graph/annotation").AnnotationRoot<{
    ...
    turnRoutingDecision: import("@langchain/langgraph/dist/channels/base").BaseChannel<TurnRoutingDecision, TurnRoutingDecision | import("@langchain/langgraph/dist/constants").OverwriteValue<TurnRoutingDecision>, unknown>;
