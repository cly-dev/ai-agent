...
export type SkillIntentMismatchCode = 'read_intent_vs_http_skill' | 'read_intent_vs_host_only_skill' | 'write_intent_vs_http_only_skill' | 'write_intent_vs_no_host_skill' | 'direct_answer_vs_any_skill' | 'orchestrated_http_vs_host_only_skill';
