...
export declare function isPossibleIncompleteBlocksJsonRemainder(remainder: string): boolean;
...
export declare function extractProseFromSummarizeLlmRaw(raw: string): string | null;
