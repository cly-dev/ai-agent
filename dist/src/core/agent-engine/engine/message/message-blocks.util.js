...
function findInlineSummarizeBlocksJsonStart(messageText, emittedProseLength) {
    ...
    const inline = rest.search(/\{\s*["']?(?:blocks|pendingWriteToolCall|type|content)["']?\s*:/);
    if (inline >= 0) {
    ...
    if ((loneBrace === null || loneBrace === void 0 ? void 0 : loneBrace.index) != null &&
