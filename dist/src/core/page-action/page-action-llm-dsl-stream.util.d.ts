import { type HostToolDeliveryContract } from '../host-bridge/host-tool-delivery-contract.util';
...
export declare function canPageActionDispatchDsl(hostTool: ResolvedPageActionHostTool): boolean;
