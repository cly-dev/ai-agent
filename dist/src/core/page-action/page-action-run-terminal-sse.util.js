...
function resolvePageActionRunTerminalOutcome(input) {
    var _a, _b, _c, _d, _e, _f;
    const errorFillText = ((_a = input.fillText) === null || _a === void 0 ? void 0 : _a.trim()) || ((_b = input.errorMessage) === null || _b === void 0 ? void 0 : _b.trim()) || null;
    if (input.suspended) {
        return {
            phase: 'awaiting_approval',
            fillText: ((_c = input.fillText) === null || _c === void 0 ? void 0 : _c.trim()) || null,
            errorCode: null,
            errorMessage: null,
        };
    }
    if (input.errorCode) {
        return {
            ...
            errorMessage: (_d = input.errorMessage) !== null && _d !== void 0 ? _d : input.errorCode,
        };
    }
    const trimmedFill = (_f = (_e = input.fillText) === null || _e === void 0 ? void 0 : _e.trim()) !== null && _f !== void 0 ? _f : '';
