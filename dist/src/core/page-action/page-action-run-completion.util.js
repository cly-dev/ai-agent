...
function dslDispatchFailedCompletion(fillText) {
    return {
        kind: 'failed',
        errorCode: 'DSL_DISPATCH_FAILED',
        errorMessage: fillText.trim().length > 0
...
function completionFromTextWithDsl(input) {
    ...
    return { kind: 'text', fillText, dslOutcome: (_a = input.dslOutcome) !== null && _a !== void 0 ? _a : null };
}
...
function completionFromSummarizeText(summaryText, dslOutcome) {
    ...
    return { kind: 'text', fillText, dslOutcome: dslOutcome !== null && dslOutcome !== void 0 ? dslOutcome : null };
}
