...
exports.SessionTaskResumeFollowUpService = exports.taskResumeFollowUpSchema = void 0;
    ...
    async classify(input) {
        ...
        try {
            ...
            const structured = await model
                .withStructuredOutput(exports.taskResumeFollowUpSchema)
                .invoke(fittedMessages);
            return exports.taskResumeFollowUpSchema.parse(structured);
        }
        catch (error) {
            ...
            if (task.stepProgress.some((step) => step.status === 'pending' || step.status === 'running')) {
                return {
